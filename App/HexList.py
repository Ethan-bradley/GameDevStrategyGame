...
class HexList():
	def __init__(self):
		self.hexList = []
		first_row = [['Caribbean Sea',True,0,'#3262a8','Spain',False,0,0,0,0],['Caribbean Sea',True,0,'#3262a8','Neutral',False,0,0,0,0],['Caribbean Sea',False,100,'#3262a8','Neutral', False,0,1,0,0],['Caribbean Sea',True,50,'#3262a8','Neutral', False,1,0,0,0],['Caribbean Sea',True,0,'#3262a8','Neutral', False,0,0,0,0],['Caribbean Sea',True,0,'#3262a8','Neutral',False,0,0,0,0], ['Barbados', False, 100,'#fc2403','UK', True,0,0,0,2]]
		second_row = [['Cayman',False,0,'#d2d6d5','Neutral', False, 0,1,1,0],['Caribbean Sea',True,0,'#3262a8','Neutral', False, 0,0,0,0],['Caribbean Sea',False,50,'#3262a8','Neutral', False,2,0,0,0],['Caribbean Sea',False,100,'#3262a8','Neutral', True,0,2,0,0],['Caribbean Sea',True,0,'#3262a8','Neutral', False,0,0,0,0],['Caribbean Sea', True, 50,'#3262a8','Neutral', False,2,0,0,0], ['Caribbean Sea', True, 50,'#3262a8','Neutral', False,0,0,0,1]]
		...
		seventh_row = [['Atlantic Ocean',True,0,'#3262a8','France', False,0,0,0,0],['Atlantic Ocean',True,0,'#3262a8','Neutral', False,0,0,0,0],['Bahamas',False,30,'#d2d6d5','Neutral', False,0,1,0,1],['Atlantic Ocean',True,100,'#3262a8','Neutral', True,0,1,0,0],['Atlantic Ocean',True,70,'#3262a8','Neutral', False,2,0,0,0],['Atlantic Ocean', True, 70,'#3262a8','Neutral', False,0,1,0,0], ['Bermuda', False, 50,'#15ad31','Italy', False,0,1,1,0]]
