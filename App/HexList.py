...
class HexList():
	def __init__(self):
		...
		second_row = [['Atlantic Ocean',True,0,'#3262a8','Spain', False, 0,0,0,0],['Atlantic Ocean',True,0,'#3262a8','Spain', False, 0,0,0,0],['Castille',False,50,'#e8cf10','Spain', False,1,0,0,0],['Madrid',False,100,'#e8cf10','Spain', True,0,1,0,0],['North Baleric Sea',True,0,'#3262a8','France', False,0,0,0,0],['Lombardy', False, 50,'#15ad31','Italy', False,0,1,0,0], ['Venice', False, 50,'#15ad31','Italy', False,0,0,0,1]]
