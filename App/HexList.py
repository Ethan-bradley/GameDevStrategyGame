...
class HexList():
	def __init__(self):
		self.hexList = []
		first_row = [['Atlantic Ocean',True,0,'#3262a8','Spain',False,0,0,0,0],['Atlantic Ocean',True,0,'#3262a8','Spain',False,0,0,0,0],['Portugal',False,100,'#d2d6d5','Neutral', False,0,1,0,0],['Andalusia',False,50,'#e8cf10','Spain', False,1,0,0,0],['South Baleric Sea',True,0,'#3262a8','Spain', False,0,0,0,0],['Tyrrhenian Sea',True,0,'#3262a8','Italy',False,0,0,0,0], ['Rome', False, 100,'#15ad31','Italy', True,0,0,0,1]]
		second_row = [['Atlantic Ocean',True,0,'#3262a8','Spain', False, 0,0,0,0],['Atlantic Ocean',True,0,'#3262a8','Spain', False, 0,0,0,0],['Castille',False,50,'#e8cf10','Spain', False,2,0,0,0],['Madrid',False,100,'#e8cf10','Spain', True,0,2,0,0],['North Baleric Sea',True,0,'#3262a8','France', False,0,0,0,0],['Lombardy', False, 50,'#15ad31','Italy', False,2,0,0,0], ['Venice', False, 50,'#15ad31','Italy', False,0,0,0,1]]
		...
		sixth_row = [['Wales',False,100,'#fc2403','UK', False,0,0,1,0],['Midlands',False,100,'#fc2403','UK', True,0,0,1,0],['North Sea',True,0,'#3262a8','UK', False,0,0,0,0],['North Sea',True,0,'#3262a8','Neutral', False,0,0,0,0],['Netherlands',False,100,'#d2d6d5','Neutral', True,0,1,0,0],['Hamburg', False, 50,'#808080','Germany', False,0,1,0,0], ['Berlin', False, 50,'#808080','Germany', False,0,0,0,0]]
		seventh_row = [['Atlantic Ocean',True,0,'#3262a8','UK', True,0,0,0,0],['Lancashire',False,100,'#fc2403','UK', True,0,0,0,1],['North Sea',True,0,'#3262a8','UK', False,0,0,0,0],['North Sea',True,50,'#3262a8','Neutral', False,0,0,0,0],['North Sea',True,0,'#3262a8','Neutral', False,0,0,0,0],['North Sea',True,0,'#3262a8','Germany', False,0,0,0,0], ['Denmark', False, 50,'#d2d6d5','Neutral', False,0,0,0,1]]
